...
MOUSE_LAYER = """\
         ...
         * `excluded-positions`.
         *
         * Those excluded positions are the seven keys bound below (y u /
         * h j k / n m — positions 6 7 18 19 20 30 31). Move a binding here and
        ...
        layer_6 {
            ...
            &trans  &trans  &trans  &trans  &trans  &trans   &kp END     &kp HOME    &trans      &trans  &trans  &trans
